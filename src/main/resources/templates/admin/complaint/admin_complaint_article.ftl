	        ...
	        <form  class="col-12">
	          <div class="form-row">
	          	<div class="form-group col-md-4">
			         	<input type="text" class=" form-control" id="art_title" name="art_title" placeholder="请输入要查询的文章标题" autocomplete="off"/>
                </div>
                <div class="form-group col-md-4">
		...
		<div class="modal-dialog">
			...
			<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button> -->
				...
				<div class="modal-body">
			         <form class="form-horizontal" role="form" id="art_editform">
			         	  <input type="hidden" id="ArtId" name="ArtId"/>
			         	  <div class="form-group">
					    		<label for="artTitle" class="col-sm-2 control-label">整改文章:</label>
					    		<div class="col-sm-5">
					    			<input type="text" class="form-control" id="artTitle" name="artTitle" readonly placeholder="请输入文章标题"/>
					    		</div>
					      </div>
					      <div class="form-group">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <table class="table table-hover table-responsive" id="complaint_art_table"></table>
    </div>
</div>
...
<script type='text/javascript'>
$(function() {
	$('#complaint_art_table').bootstrapTable('destroy');
	$('#complaint_art_table').bootstrapTable({
	    url: "/admin/complaint/article/list",
...
function reloadTable() {
	//console.log(11);
	$("#complaint_art_table").bootstrapTable('refresh');
}
// 重置按钮，重置所有查询条件
function reloadAll() {
	$("input[name=art_title]").val("");
