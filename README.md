...
#### 项目使用SpringBoot+freemaker+Ehcache+MyBatis+SpringBoot DATAJPA
#### 包含了前显示和后台管理，基本功能全部实现，部署后可以加上第三方登录，已经预留了，直接换上api接口就好
#### 邮件发送可以在工具类中换上自己的qq邮箱和stmp授权码
#### 浏览量上使用了Spring的定时任务实现
#### 页面布局方面使用了BootStrap的栅格系统，前后台都支持移动端显示
#### 效果显示可以点开下方图片链接查看
## 效果显示
